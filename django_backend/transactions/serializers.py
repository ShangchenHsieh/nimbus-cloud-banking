...
from .models import CheckImageDepositTransaction
...
class ProcessCheckDepositSerializer(serializers.ModelSerializer): 
    
    account_number = serializers.CharField(max_length=10)
    amount = serializers.DecimalField(max_digits=10, decimal_places=2)
    
    class Meta: 
        model = CheckImageDepositTransaction
    ...
    def create(self, validated_data):
        ...
        deposit = CheckImageDepositTransaction.objects.create(
