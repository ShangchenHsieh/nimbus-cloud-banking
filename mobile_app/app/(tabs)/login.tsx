...
import AsyncStorage from '@react-native-async-storage/async-storage'; // For storing authToken
//import { RootParamList } from '././expo-env';
...
const Login = () => {
  ...
  const submitLogin = async () => {
    const requestOptions = {
      ...
      body: JSON.stringify({
        email: formData.username, // Match the field name with the backend
  ...
  // Validate form fields and submit login
  const handleSubmit = () => {
