...
const questions = [
   ...
   },
   {
      ...
      answer: (
         <>
            You can send us an email on the contact page <Link to="/contact">here</Link>.
         </>
      ),
   ...
   },
   {
      ...
      answer: (
         <>
            You can change your information in the settings <Link to="/settings">here</Link>. If you’re still having trouble, please{" "}
            <Link to="/help">Talk to us here</Link>.
         </>
      ),
      categories: ["Account"],
   },
   {
      ...
      answer: (
         <>
            Update your account settings <Link to="/settings">here</Link> by clicking edit and entering the new information.
         </>
      ),
      categories: ["Account", "Navigation"],
   },
   ...
   },
   {
      ...
      answer: (
         <>
            You can download documents like your tax activity, monthly, and annual statements in the settings{" "}
   ...
   },
   {
      ...
      answer: (
         <>
            You can see us on the 'about us' page <Link to="/about">here</Link>.
         </>
      ),
      categories: ["Info", "Navigation"],
   },
   {
      ...
      answer: (
         <>
            You can send us a message <Link to="/contact">here</Link>.
         </>
      ),
      categories: ["Info", "Navigation"],
   },
   ...
   },
   {
      ...
      answer: (
         <>
            Ensure the information is accurate. If you’re still having trouble, contact us{" "}
